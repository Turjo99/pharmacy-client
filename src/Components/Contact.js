...
const Contact = () => {
  return (
    <div>
      <section class="min-h-screen bg-neutral text-white my-5">
        <div class="container flex flex-col min-h-screen px-6 py-12 mx-auto">
          <div class="flex-1 lg:flex lg:items-center lg:-mx-6">
            ...
            <div class="mt-8 lg:w-1/2 lg:mx-6">
              <div class="w-full px-8 py-10 mx-auto overflow-hidden  shadow-2xl rounded-xl text-black bg-neutral-content">
                ...
                <form class="mt-6">
                  ...
                  <button class="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide bg-slate-900 rounded-lg text-white">
                    get in touch
                  </button>
                </form>
              </div>
